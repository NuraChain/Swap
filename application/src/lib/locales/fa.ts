...
export const fa: Dict = {
    ...
    landing:
    {
        ...
        featureEarnBody: 'هر معامله کارمزدی به استخر خودش می‌پردازد. دو توکن واریز کنید، توکن LP بگیرید و سهم شما از هر معامله تا زمان برداشت روی موقعیتتان انباشته می‌شود.',
    ...
    {
        protocol: 'نسخه',
        v2Hint: 'استخرهای حاصل‌ضرب ثابت. یک قیمت در سراسر منحنی و سود همه تأمین‌کنندگان از تمام آن.',
        v3Hint: 'نقدینگی متمرکز. یک پله کارمزد و یک بازه قیمت انتخاب کنید؛ درون بازه سرمایه‌تان کاراتر است و بیرون آن سودی نمی‌سازد.',
        feeTier: 'پله کارمزد',
        ...
        chartFromV2: 'هنوز معامله‌ای در نسخه ۳ برای این جفت نیست؛ نمودار استخر نسخه ۲ را نشان می‌دهد که قیمتش جدا تعیین می‌شود.',
        chartFromV3: 'هنوز معامله‌ای در نسخه ۲ برای این جفت نیست؛ نمودار استخر نسخه ۳ را نشان می‌دهد که قیمتش جدا تعیین می‌شود.',
        chainReadNote: 'ارقام نسخه ۳ مستقیم از زنجیره خوانده می‌شوند: ارزش قفل‌شده همان چیزی است که هر استخر اکنون نگه داشته است. حجم ۲۴ ساعته و سود کارمزد از نمایه‌ساز می‌آیند و نمایه‌ساز هنوز نسخه ۳ را دنبال نمی‌کند.',
